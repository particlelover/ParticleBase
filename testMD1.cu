...
int main(int argc, char **argv)
{
...

  {
    ...
    LJpara[0] = 3.1062;
    LJpara[1] = 3.59044e-5; // for O2-O2 (sigma, epsilon)
    LJpara[2] = 3.21365;
    LJpara[3] = 4.82095e-5; // for O2-N2 (sigma, epsilon)
    LJpara[4] = 3.21365;
    LJpara[5] = 4.82095e-5; // for N2-O2 (sigma, epsilon)
    LJpara[6] = 3.3211;
    LJpara[7] = 4.19355e-5; // for N2-N2 (sigma, epsilon)
