...
public:
  cudaCutoffBlock() : blocklen(6), blocknum(3), bindex(NULL),
                      tmp81N(NULL),
  ...
  /** set range of the blocks for this GPU
   *
   * @param offset ID for the start block
   * @param num    number of blocks
   */
  void setMyBlock(uint32_t offset, uint32_t num)
  {
